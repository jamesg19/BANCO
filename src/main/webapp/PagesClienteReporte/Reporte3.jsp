    ...
    <body align="center" >
        ...
        <div align="center" class="container profile profile-view" id="profile" >
            <table align="center" id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <h3></h3>
                <font color="black">La cuenta con mas dinero: No. de cuenta </font><font color="green"> <%=cambioss.getCodigo() %></font><font color="black"> Creada: </font><font color="green"> <%=cambioss.getCreada()%></font> <font color="black"> Credito: </font><font color="green"> <%=cambioss.getCredito()%></font>
                <thead align="center" >
                    <tr>
                        <th>No.</th>
                        <th>Codigo</th>
